export const resources = {
  EN: {
    translation: {
      ...
      FormsParticipation: 'Forms of participation',
      Contribution: 'Contribution by card',
  ...
  UA: {
    translation: {
      ...
      FormsParticipation: 'Форми участі',
      Contribution: 'Внесок картою ',
      InUkraine: 'По Україні ',
      FromAbroad: 'Із-за кордону',
      Recipient: 'Отримувач',
      PaymentPurpose: 'Призначення платежу',
      BankName: 'Назва банку',
      Currency: 'Валюта',
      CodeBank: 'Код ЄДРПОУ',
      CharitableOrganization: 'Благодійна організація',
